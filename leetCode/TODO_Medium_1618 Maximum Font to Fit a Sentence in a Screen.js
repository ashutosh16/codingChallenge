...
// }
// The calculated width of text for some fontSize is the sum of every getWidth(fontSize, text[i])
// call for each 0 <= i < text.length (0-indexed). The calculated height of text for some 
// fontSize is getHeight(fontSize). Note that text is displayed on a single line.

// It is guaranteed that FontInfo will return the same value if you call getHeight or 
// getWidth with the same parameters.
